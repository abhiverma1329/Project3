...
<style type="text/css">
.raj {
	background-image: linear-gradient(to bottom right, SeaGreen, DarkBlue, green);
	...
	<div class="header">
		...
		<button class="navbar-toggler " type="button" data-toggle="collapse"
			...
			aria-expanded="false" aria-label="Toggle navigation">
				<i style="color: #fff; font-size: 28px;" class="fa fa-bars"></i></span>
		</button>
			...
			<ul class="nav navbar-nav ml-auto">
				...
				<li class="nav-item dropdown"><a
					...
					aria-expanded="false"><i
							class="fa fa-file"> <font style="color: white;">Marksheet</font>
				</a>
				...
				<li class="nav-item dropdown" style="padding-left: 5px;"><a
					...
					role="button" data-toggle="dropdown" aria-haspopup="true"
					aria-expanded="false"> <i
							class="fa fa-users"></i> <font style="color: white;">User</font>
				</a>
					<div class="dropdown-menu" aria-labelledby="navbarDropdown">
				...
				<li class="nav-item dropdown" style="padding-left: 5px"><a
					class="nav-link dropdown-toggle" href="#" id="navbarDropdown"
					role="button" data-toggle="dropdown" aria-haspopup="true"
					aria-expanded="false"><i class="fa fa-file"></i> <font style="color: white;">Marksheet
					</font></a>
				...
				<li class="nav-item dropdown" style="padding-left: 5px"><a
					...
					role="button" data-toggle="dropdown" aria-haspopup="true"
					aria-expanded="false"><i
							class="fa fa-tag"></i> <font style="color: white;">Role</font>
				</a>
					<div class="dropdown-menu" aria-labelledby="navbarDropdown">
				...
				<li class="nav-item dropdown" style="padding-left: 5px"><a
					...
					role="button" data-toggle="dropdown" aria-haspopup="true"
					aria-expanded="false"> <i
							class="fa fa-graduation-cap"></i> <font style="color: white;">College</font>
				</a>
					<div class="dropdown-menu" aria-labelledby="navbarDropdown">
				...
				<li class="nav-item dropdown" style="padding-left: 5px"><a
					...
					role="button" data-toggle="dropdown" aria-haspopup="true"
					aria-expanded="false"><i
							class="fa fa-book"></i> <font style="color: white;">Course
					</font></a>
					<div class="dropdown-menu" aria-labelledby="navbarDropdown">
				...
				<li class="nav-item dropdown" style="padding-left: 5px"><a
					class="nav-link dropdown-toggle" href="#" id="navbarDropdown"
					role="button" data-toggle="dropdown" aria-haspopup="true"
					aria-expanded="false"><i class="fa fa-th-list"></i> <font style="color: white;">Student</font>
				</a>
					<div class="dropdown-menu" aria-labelledby="navbarDropdown">
				...
				<li class="nav-item dropdown" style="padding-left: 5px"><a
					...
					role="button" data-toggle="dropdown" aria-haspopup="true"
					aria-expanded="false"> <i
							class="fa fa-users"></i>  <font style="color: white;">Faculty
					</font></a>
					<div class="dropdown-menu" aria-labelledby="navbarDropdown">
				...
				<li class="nav-item dropdown" style="padding-left: 5px"><a
					...
					role="button" data-toggle="dropdown" aria-haspopup="true"
					aria-expanded="false"><i
							class="fa fa-calendar"></i> <font style="color: white;">Time
							Table</font>
				</a>
					<div class="dropdown-menu" aria-labelledby="navbarDropdown">
				...
				<li class="nav-item dropdown" style="padding-left: 5px"><a
					class="nav-link dropdown-toggle" href="#" id="navbarDropdown"
					role="button" data-toggle="dropdown" aria-haspopup="true"
					aria-expanded="false"> <i class="fa fa-file"></i><font style="color: white;">Subject</font>
				</a>
					<div class="dropdown-menu" aria-labelledby="navbarDropdown">
				...
				<li class="nav-item dropdown"
					style="padding-left: 3px; padding-right: 40px"><a
					class="nav-link dropdown-toggle" href="#" id="navbarDropdown"
					role="button" data-toggle="dropdown" aria-haspopup="true"
					aria-expanded="false"><i class="fa fa-user-circle" aria-hidden="true"></i><font style="color: white;"><%=welcomeMsg%>
					</font></a>
					<div class="dropdown-menu" aria-labelledby="navbarDropdown">
						<%
							if (userLoggedIn) {
