...
.hm {
	background-image: url('<%=ORSView.APP_CONTEXT%>/imgs/List.webp');
	background-size: 100%;
	padding-top: 80px;
...
<body  class="hm" >
	...
	<div>
		<form action="<%=ORSView.TIMETABLE_LIST_CTL%>" method="post">
			...
			%>
			<center>
					<h1 class="text-black font-weight-bold pt-2"><u>Timetable
					List</u></h1>
				</center>
				</br>
			...
			<div style="margin-bottom: 20px;" class="table-responsive">
				<table class="table table-info table-bordered table table-hover">
					<thead>
