...
.p4{
background-image: url('<%=ORSView.APP_CONTEXT%>/imgs/user.webp');
	background-size: 100%;
	padding-top: 80px;
...
.grad{
background-image: linear-gradient(to bottom right, cyan, white);
background-repeat: no repeat;
background-size: 100%;
padding-bottom: 11px;
}
...
<%-- .hm-gradient {
	background-image: url('<%=ORSView.APP_CONTEXT%>/imgs/add4.webp');
} --%>
</style>
</head>
<body class="p4">
