...
public class UserModelTest {
	...
	private static void testAuth() throws ApplicationException {
		UserDTO dto= model.authenticate("abhi99@gmail.com", "Abhi@1234");
	...
	public static void addTest() throws Exception {
		...
		dto.setDob(sdf.parse("23-06-1999"));
		dto.setConfirmPassword("Abhi@1234");
		dto.setPassword("Abhi@1234");
		dto.setLogin("abhi99@gmail.com");
		dto.setGender("male");
		...
		dto.setRegisteredIP("abhi99@gmail.com");
		dto.setLoginIP("abhi99@gmail.com");
